...
export const getAnalyticsSummary = () =>
  API.get("/api/trades/analytics/summary");

export const getEquityCurve = () =>
  API.get("/api/trades/analytics/equity-curve");

export const getMonthlyAnalytics = () =>
  API.get("/api/trades/analytics/monthly");

export const getAdvancedAnalytics = () =>
  API.get("/api/trades/analytics/advanced");
...
/* ✅ ADD THIS */
export const getRecentTrades = (params?: { limit?: number }) =>
  API.get("/api/trades/recent", { params });
