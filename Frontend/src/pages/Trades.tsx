...
export default function Trades() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* FILTERS & CONTROLS */}
      <div className="bg-white dark:bg-black rounded-xl border border-gray-200 dark:border-gray-800 p-4 sm:p-5">
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="relative hidden sm:block">
              ...
              <TrendingUp className="absolute right-2 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-gray-500 pointer-events-none" />
            </div>

            {/* View Toggle */}
            <button
              onClick={() => setIsGridView(!isGridView)}
              className="p-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 
        ...
        {/* QUICK STATS BAR */}
        <div className="flex items-center gap-4 mt-4 pt-4 border-t border-gray-200 dark:border-gray-800 text-sm">
      ...
      {loading ? (
            ...
            return (
              <div
                ...
                className="bg-white dark:bg-black rounded-xl border border-gray-200 dark:border-gray-800 
                         overflow-hidden hover:shadow-md dark:hover:shadow-gray-900 transition-shadow"
              >
                {/* Trade Header */}
                  ...
                  {isExpanded && (
                    <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800 space-y-3">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-mono text-xs text-gray-500 dark:text-gray-500">{trade._id.slice(-8)}</span>
                      </div>
        ...
        <div className="bg-white dark:bg-black rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                {filteredTrades.map((trade) => {
                  ...
                  return (
                    <tr key={trade._id} className="hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors">
          ...
          {filteredTrades.length > 0 && (
            <div className="px-4 py-3 border-t border-gray-200 dark:border-gray-800 flex items-center 
